...
export const HOUSE_CONSTRAINTS = [
  'Research first with side-effect-free workers; any repo mutation happens only via a gated action inside a fresh git worktree under /Users/niall/work/erdo/workspace (branch from origin/main) — never in the user\'s checkouts',
 ...
 * ~/work/erdo with a read-only worker, but a named repo skips that pass.
